...
# Construct a dictionary to pass to the template engine as its context.Note the key boldmessage is the same as {{ boldmessage }} in the template!
...
def about(request):
	...
	context_dict = {'boldmessage': "Gosia"}
